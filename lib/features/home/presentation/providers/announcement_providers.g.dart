...
/// See also [latestAnnouncementTitle].
@ProviderFor(latestAnnouncementTitle)
final latestAnnouncementTitleProvider =
    AutoDisposeFutureProvider<String?>.internal(
      latestAnnouncementTitle,
      name: r'latestAnnouncementTitleProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$latestAnnouncementTitleHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
