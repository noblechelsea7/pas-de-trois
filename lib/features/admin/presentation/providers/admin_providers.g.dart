...
String _$adminAnnouncementsHash() =>
    r'd22f4fca44e34ab2c3c240503d76aa83ad9c1f4e';

/// See also [adminAnnouncements].
@ProviderFor(adminAnnouncements)
final adminAnnouncementsProvider =
    AutoDisposeFutureProvider<List<Announcement>>.internal(
      adminAnnouncements,
      name: r'adminAnnouncementsProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$adminAnnouncementsHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );
